...
use App\Models\User;
use App\Passkeys\DynamicRpFindPasskeyToAuthenticateAction;
use App\Passkeys\DynamicRpGeneratePasskeyAuthenticationOptionsAction;
use App\Passkeys\DynamicRpGeneratePasskeyRegisterOptionsAction;
...
return [
     ...
     */
    'actions' => [
        'generate_passkey_register_options' => DynamicRpGeneratePasskeyRegisterOptionsAction::class,
        'store_passkey' => StorePasskeyAction::class,
        'generate_passkey_authentication_options' => DynamicRpGeneratePasskeyAuthenticationOptionsAction::class,
        'find_passkey' => DynamicRpFindPasskeyToAuthenticateAction::class,
